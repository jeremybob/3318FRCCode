...
public class ShooterSubsystem extends SubsystemBase {
    private final TalonFX leftShooter =
            new TalonFX(Constants.CAN.SHOOTER_LEFT, new CANBus(Constants.CAN.CANIVORE_BUS));
    private final TalonFX rightShooter =
            new TalonFX(Constants.CAN.SHOOTER_RIGHT, new CANBus(Constants.CAN.CANIVORE_BUS));
